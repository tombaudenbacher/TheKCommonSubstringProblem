...
int main(){
    ...
    //std::string Chromosom4;
    //std::string Chromosom5;
    //std::string Chromosom6;
    //std::string Chromosom7;
    ...
    //std::ifstream file4("Chromosom4Output.fa");
    //std::getline(file4, Chromosom4);
    //std::ifstream file5("Chromosom5Output.fa");
    //std::getline(file5, Chromosom5);
    //std::ifstream file6("Chromosom6Output.fa");
    //std::getline(file6, Chromosom6);
    //std::ifstream file7("Chromosom7Output.fa");
    //std::getline(file7, Chromosom7);

    inputstrings[0] = Chromosom1;
    inputstrings[1] = Chromosom2;
    inputstrings[2] = Chromosom3;
    //inputstrings[3] = Chromosom4;
    //inputstrings[4] = Chromosom5;
    //inputstrings[5] = Chromosom6;
    //inputstrings[6] = Chromosom7;

    std::cout << inputstrings[0].size() << std::endl;
    std::cout << inputstrings[1].size() << std::endl;
    std::cout << inputstrings[2].size() << std::endl;
    //std::cout << inputstrings[3].size() << std::endl;
    //std::cout << inputstrings[4].size() << std::endl;
    //std::cout << inputstrings[5].size() << std::endl;
    //std::cout << inputstrings[6].size() << std::endl;

    std::cout << inputstrings[0].size() + inputstrings[1].size() + inputstrings[2].size()/* + inputstrings[3].size() + inputstrings[4].size() + inputstrings[5].size() + inputstrings[6].size() */<< std::endl;

    std::chrono::milliseconds timeForAlgorithm{0};
    ...
    timeForAlgorithm = timeForAlgorithm + std::chrono::duration_cast<std::chrono::milliseconds>(end - start);
    for(int j=0; j<result.size(); j++){
        std::cout << j << ": " << result[j].size() << std::endl;
    }
    ...
    std::cout << "Time taken by algorithm: " << timeForAlgorithm.count() << " milliseconds" << std::endl;
}
